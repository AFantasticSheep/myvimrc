...
nnoremap <Leader>ye :YcmCompleter GoToDeclaration<CR>
" }}}
...
let g_unite_source_rec_async_command = ['ag', '--follow', '--nocolor',  '--nogroup', '--hidden', '-g', '']
" }}}
...
let g:gutentags_gtags_executable='/usr/local/bin/gtags'
" }}}
